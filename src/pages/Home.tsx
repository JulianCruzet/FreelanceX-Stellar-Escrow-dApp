    ...
    <PageTransition>
      ...
      <section className="relative w-full h-[650px] flex items-center justify-center overflow-hidden bg-gradient-to-r from-yellow-400 to-orange-500">
        ...
        <div className="relative z-30 flex flex-col items-start justify-center h-full text-left px-10 w-full max-w-none">
          ...
          <Link
            to="/create-job"
            className="w-full max-w-xs px-8 py-5 bg-transparent border-2 border-orange-500 text-orange-500 rounded-lg font-semibold text-lg shadow-lg transition-all text-center hover:bg-orange-500 hover:text-white"
          >
            Post a Job
          </Link>
        </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { title: "Development", count: "1,234" },
              { title: "Design", count: "2,345" },
              { title: "Marketing", count: "3,456" },
              { title: "Writing", count: "4,567" }
            ].map((category, index) => (
              <motion.div
                key={index}
                ...
                whileHover={{ y: -4 }}
                className="bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-orange-500"
              >
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link
              to="/jobs"
              className="text-orange-500 hover:text-orange-600 font-medium flex items-center gap-2 group text-lg"
            >
              View all jobs
